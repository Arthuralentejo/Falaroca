...
/* Title of the Blog */
#blog-title     { left:40px; position:fixed; top:6px; max-width:237px; }
...
/* Top Menu */
.map-menu-top                       { position:fixed; top:25px; z-index:10; font-size: 1.6em; right: 40px; }
.map-menu-top ul                    { list-style:none; margin:0; padding:0; }
.map-menu-top ul li                 { float:left; padding:0; }
.map-menu-top ul li a               { background:rgba(41,41, 41, 0.8); color:rgb(250,250, 250); display:block; padding:6px 9px; font-family: "Bebas"; font-weight: normal; text-decoration:none; }
.map-menu-top ul li a:hover         { background:rgb(222,57, 57); }
...
#toggle-side-menu-icon              { background:rgba(41,41, 41, 0.8); padding:3px; }
#toggle-side-menu-icon:hover        { background:rgb(222,57, 57); }
...
.map-menu-side ul li a              { background:rgba(41,41, 41, 0.8); color:rgb(250,250, 250); display:block; padding:6px 9px; text-decoration:none; }
.map-menu-side ul li a:hover        { background:rgb(222,57, 57); }
...
li.current-menu-item a              { background:rgb(222,57, 57) !important; }
li.current-menu-item li a:hover     { background:rgba(41,41, 41, 0.8) !important; }
...
/* Filters */
#toggle-filters { background:#000; color:<?php echo $fontColor; ?>; cursor:pointer; float:right; font-weight:bold; padding:4px 14px 2px 10px; text-transform:uppercase; width:177px;}
...
/* Results */
#toggle-results { background:#000; cursor:pointer; padding:4px 4px 0 4px; position:fixed; right:0; top:120px; }
#results { background:#fff; color:#fff; display:none; max-height:65%; overflow:auto; padding:9px; opacity: .9; position:fixed; right:35px; top:120px; width:30%; }
#results h1 { font-size:20px; margin-bottom:27px; }
...
.result h1 a { color:#000; text-decoration:none; text-transform:uppercase; }
...
.balloon h1 a       { color:#000; text-decoration:none; }
...
#post_overlay a#close_post_overlay          { background:#000; cursor:pointer; padding:4px 4px 0 4px; position:absolute; right:0; top:120px; z-index:1000; }
#post_overlay a#close_post_overlay:hover    { background:#000; }
...
#post_overlay #entry-content                { font-size:14px; padding:0 36px 0 0; }
