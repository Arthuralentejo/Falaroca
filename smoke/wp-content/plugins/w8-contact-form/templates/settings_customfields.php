...
<div class="wrap w8contact_form">
	<br />
	<h3><?php esc_html_e( 'Custom Fields', W8CONTACT_FORM_TEXT_DOMAIN );?><hr /></h3>
	<p>
	<?php esc_html_e( 'Fields with marked * are mandatory to save the custom field. The row marked with red background if it has missing parameters during the save process.', W8CONTACT_FORM_TEXT_DOMAIN );
	...
	?>
		...
		<div class="custom_field_section">
			...
			<div class="fields_save_area">
				<div class="cfs-cf-save-container"><div class="acfield save_custom_fields button button-primary button-large"><?php esc_html_e( 'SAVE', W8CONTACT_FORM_TEXT_DOMAIN );?></div></div>
				<div class="fields_add_area">
					<div class="acfield add_custom_fields button button-secondary button-large"><?php esc_html_e( 'ADD TEXT FIELD', W8CONTACT_FORM_TEXT_DOMAIN );?></div>
					<div class="acfield add_custom_fields_textarea button button-secondary button-large"><?php esc_html_e( 'ADD TEXTAREA', W8CONTACT_FORM_TEXT_DOMAIN );?></div>
					<div class="acfield add_custom_fields_radio button button-secondary button-large"><?php esc_html_e( 'ADD RADIO BUTTONS', W8CONTACT_FORM_TEXT_DOMAIN );?></div>
					<div class="acfield add_custom_fields_checkbox button button-secondary button-large"><?php esc_html_e( 'ADD CHECKBOX', W8CONTACT_FORM_TEXT_DOMAIN );?></div>
					<div class="acfield add_custom_fields_select button button-secondary button-large"><?php esc_html_e( 'ADD SELECT BOX', W8CONTACT_FORM_TEXT_DOMAIN );?></div>
					<div class="acfield add_custom_fields_hidden button button-secondary button-large"><?php esc_html_e( 'ADD HIDDEN FIELD', W8CONTACT_FORM_TEXT_DOMAIN );?></div>
				</div>
			</div>
		</div>
</div>